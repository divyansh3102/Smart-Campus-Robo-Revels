...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: LostandfindWidget.routeName,
          path: LostandfindWidget.routePath,
          builder: (context, params) => LostandfindWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TaskmanegerWidget.routeName,
          path: TaskmanegerWidget.routePath,
          builder: (context, params) => TaskmanegerWidget(),
        ),
        FFRoute(
          name: AddtasksWidget.routeName,
          path: AddtasksWidget.routePath,
          builder: (context, params) => AddtasksWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: DisplayWidget.routeName,
          path: DisplayWidget.routePath,
          builder: (context, params) => DisplayWidget(),
        ),
        FFRoute(
          name: EventuploadWidget.routeName,
          path: EventuploadWidget.routePath,
          builder: (context, params) => EventuploadWidget(),
        )
